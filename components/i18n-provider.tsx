...
const dict: Dict = {
  ...
  // Pricing
  "pricing.title": { en: "Pricing", zh: "定价" },
  "pricing.subtitle": { en: "Choose a plan that fits your workflow. Upgrade anytime.", zh: "选择适合你的方案，随时升级。" },
  "pricing.popular": { en: "Most Popular", zh: "最受欢迎" },
  "pricing.cta.get_started": { en: "Get Started", zh: "开始使用" },
  "pricing.cta.buy_pro": { en: "Buy Pro", zh: "购买 Pro" },
  "pricing.cta.buy_business": { en: "Buy Business", zh: "购买 Business" },
  "pricing.plan.free.name": { en: "Free", zh: "免费" },
  "pricing.plan.pro.name": { en: "Pro", zh: "专业版" },
  "pricing.plan.business.name": { en: "Business", zh: "企业版" },
  "pricing.period.forever": { en: "/forever", zh: "/永久免费" },
  "pricing.period.month": { en: "/month", zh: "/月" },
  "pricing.feature.free.1": { en: "Basic editor", zh: "基础编辑器" },
  "pricing.feature.free.2": { en: "Community models", zh: "社区模型" },
  "pricing.feature.free.3": { en: "Watermarked output", zh: "带水印输出" },
  "pricing.feature.pro.1": { en: "HD output, no watermark", zh: "高清输出，无水印" },
  "pricing.feature.pro.2": { en: "Faster queue & priority", zh: "更快队列与优先权" },
  "pricing.feature.pro.3": { en: "Commercial usage", zh: "可商用" },
  "pricing.feature.pro.4": { en: "Email support", zh: "邮件支持" },
  "pricing.feature.business.1": { en: "Everything in Pro", zh: "包含专业版全部功能" },
  "pricing.feature.business.2": { en: "Team seats (3 included)", zh: "团队席位（含 3 个）" },
  "pricing.feature.business.3": { en: "API access", zh: "API 访问" },
  "pricing.feature.business.4": { en: "SLA & priority support", zh: "SLA 与优先支持" },
  // Pricing notices
  "pricing.notice.error_title": { en: "Payment Error", zh: "支付错误" },
  "pricing.notice.success_title": { en: "Payment Successful", zh: "支付成功" },
  "pricing.notice.cancelled_title": { en: "Checkout Cancelled", zh: "已取消支付" },
  "pricing.error.checkout": { en: "Checkout is currently unavailable.", zh: "当前无法发起结账。" },
  "pricing.error.network": { en: "Network error. Please try again.", zh: "网络错误，请稍后重试。" },
  "auth.logout": { en: "Logout", zh: "退出登录" },
